...
class GeodowVerticalNavExpansionPanel extends Component {
  state = {
    collapsed: true
  };
  ...
  render() {
    ...
    return (
      <div>
        <TouchRipple
          className={classList({
            "nav-item flex-middle h-48 w-100 has-submenu active": true,
            "open": !collapsed
          })}
...
export default withRouter(withStyles(styles)(GeodowVerticalNavExpansionPanel));
